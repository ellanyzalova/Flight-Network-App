 ...
 * weights.
 *
 * NodeType the data type stored at each graph vertex
 * EdgeType the data type stored at each graph edge as a Number whose
 * doubleValue() method returns
 * a value >=0.0
 */
public interface GraphADT<NodeType, EdgeType extends Number> {
     ...
     * @param time   the time for the edge (has to be a positive integer)
     * @param price  the price for the edge
    ...
    /**
     * Returns the shortest path between startingVertex and destinationVertex in
     * terms of price.
     ...
     *         vertex with data
     *         item startingVertex and vertex with data item destinationVertex,
     *         including both startingVertex
